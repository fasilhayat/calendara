...
public interface ICalendarRepository
{
    ...
    /// <returns>A task representing the asynchronous operation, containing the bank closing day description.</returns>
    Task<Holiday?> GetHolidayOrWeekendAsync(string countryCode, DateTime date);

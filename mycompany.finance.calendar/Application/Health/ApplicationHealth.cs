namespace Mycompany.Finance.Calendar.Application.Health;
...
public static class ApplicationHealth
{
    ...
    /// </summary>
    /// <param name="builder"> The <see cref="WebApplicationBuilder"/> used to configure services and middleware. </param>
